...
//     model.createGuest("b", "b", "test");
//     model.createGuest("c", "c", "test");
...
//
//     model.createOrder(new GregorianCalendar(), new GregorianCalendar(2016, 10, 30), 3);
//
//     model.createOrder(new GregorianCalendar(), new GregorianCalendar(2016, 10, 30), 4);
